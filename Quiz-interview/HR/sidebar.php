<nav class="sidebar sidebar-offcanvas" id="sidebar">
  <ul class="nav">
    ...
    <li class="nav-item">
      <a class="nav-link" href="HR.php" style="display: flex; justify-content: space-between;">
        <span class="menu-title">Request  </span>
        <!-- Notification icon with pending requests count -->
        &emsp; &emsp; &emsp;&emsp;&emsp;<span class="badge badge-warning " style="border-radius: 7px; color: black;font-size: 20px; padding-left: 15px;padding-right: 15px;">5</span>
      </a>
    </li>
    <li class="nav-item">
    ...
    <!-- <li class="nav-item">
            ...
            <li class="nav-item">
              <a class="nav-link" href="food-order.php">
