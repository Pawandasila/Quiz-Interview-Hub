...
<script>
    $(document).ready(function() {
        let currentQuestion = <?php echo $ques_no+1?>;
    ...
    function loadQuestions() {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                let value = "<div class='card-header'>"
                    value+="Category: <?php echo $section_name ?>"
                    value+="</div>";
                    value+="<div class='card-body text-center' style='padding: 1px;'>"
                    <?php
                    for ($i = 1; $i <= $totalQuestions; $i++) {
                    ?>
                        value+= "<div class='digit-box' data-question='<?php echo $i?>'><?php echo $i?></div>";
                    ...
                    value+="</div>";
                    value+="<div class='card-footer d-flex justify-content-between'>";
                    value+="<button class='btn btn-info' id='previous-btn'>&#x2190; </button>";
                    value+="<button class='btn btn-info'>End Test</button>";
                    value+="<button class='btn btn-info' id='next-btn'> &#x2192; </button>";
                    value+="</div>";
               
                // ";
                $('#category_card').append(value);
